...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.blackiron.version";
    ...
    public static final String PROP_UPDATER_ALLOW_MAJOR_UPDATE = "blackiron.updater.allow_major_update";
